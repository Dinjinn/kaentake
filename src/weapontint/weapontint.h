...
// The Key() of the effect tint BeginItemEffSwap would apply for this avatar and
// item, or 0 for none. Lets the host's effect-layer cache rebuild a layer when
// only its tint changed (same item, same action, same facing).
